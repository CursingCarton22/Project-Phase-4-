# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 22:34:36 2026
...
# ============================================================
# SINGLE SIMULATION: confirming a specific config
# ============================================================
if best_combo is None:
    raise Exception('No feasible combo found, cannot continue')
...
# ============================================================
# fixed design vector - not optimizing right now
# ============================================================
xbest = np.array([18, 0.5, 600, 0.06, 270])

# # OPTIMIZER - commented out for now
# bounds = Bounds([18, 0.2, 250, 0.05, 270], [18, 0.7, 800, 0.12, 270])
# x0 = np.array([18, 0.5, 550, 0.09, 270])
...
#     return False
# options = {'maxiter': 5, 'verbose': 0, 'disp': False}
...
edl_system['team_name'] = 'MEEN CHUDS'
edl_system['team_number'] = 47
...
print(f'Parachute diameter             = {xbest[0]:.4f} [m]')
print(f'Rocket fuel mass               = {xbest[4]:.4f} [kg]')
...
print(f'Wheel radius                   = {xbest[1]:.4f} [m]')
print(f'd2                             = {xbest[3]:.4f} [m]')
print(f'Chassis mass                   = {xbest[2]:.4f} [kg]')
